...
# 选择要获取特征图的层
target_layer_1 = Model.Conv2_1.depthwise_conv
target_layer_2 = Model.Conv2_2.depthwise_conv
target_layer_3 = Model.Conv2_3.depthwise_conv

feature_maps1 = np.zeros((2,22,92),dtype=float)
feature_maps2 = np.zeros((2,22,92),dtype=float)
feature_maps3 = np.zeros((2,22,92),dtype=float)
feature_maps = []
count = 1
i = 0
...
# 将数组保存到文件中
np.savetxt('./result_weights/se_depthwise1_feature_map1_0.txt', temp1[0,:,:])
np.savetxt('./result_weights/se_depthwise2_feature_map1_0.txt', temp2[0,:,:])
np.savetxt('./result_weights/se_depthwise3_feature_map1_0.txt', temp3[0,:,:])

np.savetxt('./result_weights/se_depthwise1_feature_map2_0.txt', temp1[1,:,:])
np.savetxt('./result_weights/se_depthwise2_feature_map2_0.txt', temp2[1,:,:])
np.savetxt('./result_weights/se_depthwise3_feature_map2_0.txt', temp3[1,:,:])
