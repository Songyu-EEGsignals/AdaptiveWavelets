...
class AWD_Model_Init(nn.Module):
    def __init__(self, wt):
        ...
        self.fc1 = DenseWithConstraint(552, 16,max_norm=0.25)
...
if __name__ == "__main__":
    with open(r'D:\pytorch1.8.0-python3.9.13\AdaptiveWavelets\data_path\BCI_2a_data\MI_data_pkl\train_sub2.pkl', 'rb') as f:
        train_loader = pickle.load(f)
    res = train_loader
    with open(r'D:\pytorch1.8.0-python3.9.13\AdaptiveWavelets\data_path\BCI_2a_data\MI_data_pkl\test_sub2.pkl', 'rb') as f:
