...
def heatmap(weight, x_ticks, x_labels, y_ticks, y_labels):
    ...
    plt.xlabel('Filter')
    plt.ylabel('Channel')
    # plt.savefig('figures/' + "小波系数4" + '.pdf', bbox_inches='tight')
    plt.show()
...
feature_map = feature_maps1.squeeze() / i
