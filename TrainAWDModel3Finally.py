...
class AWD_Model_Init(nn.Module):
    def __init__(self, wt):
        ...
        self.Conv2_1 = SeparableConv2d(1,8,kernel_size=(1,5),padding=(0,1))
        self.Conv2_2 = SeparableConv2d(1,8,kernel_size=(1,7),padding=(0,2))
        self.bn3 = nn.BatchNorm2d(16,eps=1e-03,  affine=True,momentum=0.99)
        self.avg_pool = nn.AvgPool2d((1,4))
        self.fc1 = DenseWithConstraint(368, 16,max_norm=0.125)
...
if __name__ == "__main__":
    ...
    torch.save(AWD_model.state_dict(), opj(final_model, 'finalAWD_Model.pth'))
