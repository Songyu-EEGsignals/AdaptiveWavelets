...
for batch_idx, (data, y) in enumerate(train_loader):
    ...
    # plt.title('Conv1 Feature Map FFT')
    ...
    # 设置横纵坐标范围
    x_ticks = np.arange(0, 750, 50)  # 横坐标刻度
    ...
    y_labels = ['Fz', 'FC3', 'FC1', 'FCz', 'FC2', 'FC4', 'C5', 'C3', 'C1', 'Cz', 'C2', 'C4', 'C6', 'CP3', 'CP1', 'CPz',
                'CP2', 'CP4', 'P1', 'Pz', 'P2', 'POz']  # 纵坐标标签
    heatmap(feature_map2, x_ticks, x_labels, y_ticks, y_labels)
    exit(0)
